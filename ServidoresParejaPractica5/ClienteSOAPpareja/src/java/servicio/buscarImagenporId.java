...
public class buscarImagenporId extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            Imagen resultados = null;
            //resultados = null;
            String id = request.getParameter("id");
            
            
            resultados = searchbyId(Integer.parseInt(id));
 ...
 private void sendResponse(Imagen resultados,PrintWriter out)
    {    
 ...
 private void PrintImageData(Imagen im, PrintWriter out) {
    ...
    private Imagen searchbyId(int id) {
