 ...
 * 
 */
@WebServiceClient(name = "WS", targetNamespace = "http://servicio/", wsdlLocation = "http://localhost:8080/Practica3Server/WS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WS_QNAME = new QName("http://servicio/", "WS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Practica3Server/WS?wsdl");
    ...
    public WS getWSPort() {
        return super.getPort(new QName("http://servicio/", "WSPort"), WS.class);
    }
    ...
    public WS getWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio/", "WSPort"), WS.class, features);
    }
